@echo off
REM Sandesh Email Service - Docker Image Builder (Windows)
REM This script builds and pushes Docker images to Docker Hub
...
(
echo # Sandesh Email Service - Environment Configuration
echo # Copy this file to .env and update with your values
echo.
echo # ============================================
echo # AWS SES Configuration ^(Required for SES^)
echo # ============================================
echo AWS_ACCESS_KEY_ID=your_aws_access_key
echo AWS_SECRET_ACCESS_KEY=your_aws_secret_key
echo AWS_REGION=ap-south-1
echo SES_SENDER_EMAIL=your-verified-email@domain.com
echo SES_CONFIGURATION_SET=
echo.
echo # ============================================
echo # SMTP Configuration ^(Alternative to SES^)
echo # ============================================
