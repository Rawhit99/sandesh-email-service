...
async def _stub_send(channel: ChannelType, payload: Dict[str, Any]) -> ChannelResult:
    logger.info("Channel %s not wired yet; payload keys=%s", channel.value, list(payload.keys()))
